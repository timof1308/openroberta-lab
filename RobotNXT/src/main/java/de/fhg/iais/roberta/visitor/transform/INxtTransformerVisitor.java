...
public interface INxtTransformerVisitor<V> extends ITransformerVisitor<V>, INxtVisitor<Phrase<V>> {
    ...
    default Phrase<V> visitLightStatusAction(LightStatusAction<Phrase<V>> lightStatusAction) {
        return INxtVisitor.super.visitLightStatusAction(lightStatusAction);
    }

    @Override
    default Phrase<V> visitBluetoothConnectAction(BluetoothConnectAction<Phrase<V>> bluetoothConnectAction) {
        return INxtVisitor.super.visitBluetoothConnectAction(bluetoothConnectAction);
    }
    ...
    default Phrase<V> visitBluetoothWaitForConnectionAction(BluetoothWaitForConnectionAction<Phrase<V>> bluetoothWaitForConnection) {
        return INxtVisitor.super.visitBluetoothWaitForConnectionAction(bluetoothWaitForConnection);
    }
}
