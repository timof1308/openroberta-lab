...
public class Hts221TemperatureSensor<V> extends BuiltinSensor<V> {
    ...
    public static <V> Phrase<V> jaxbToAst(Block block, AbstractJaxb2Ast<V> helper) {
        ...
        Var<V> temperature = helper.getVar(values, "");
        return Hts221TemperatureSensor.make(AbstractJaxb2Ast.extractBlockProperties(block), AbstractJaxb2Ast.extractComment(block), temperature);
    }
    ...
    public Block astToBlock() {
        ...
        Ast2JaxbHelper.addValue(block, "", this.temperature);
        return block;
    }
}