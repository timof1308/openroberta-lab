...
public interface IBotnrollTransformerVisitor<V> extends ITransformerVisitor<V>, IBotnrollVisitor<Phrase<V>> {
    ...
    default Phrase<V> visitMotorGetPowerAction(MotorGetPowerAction<Phrase<V>> motorGetPowerAction) {
        return IBotnrollVisitor.super.visitMotorGetPowerAction(motorGetPowerAction);
    }

    @Override
    default Phrase<V> visitMotorSetPowerAction(MotorSetPowerAction<Phrase<V>> motorSetPowerAction) {
        return IBotnrollVisitor.super.visitMotorSetPowerAction(motorSetPowerAction);
    }

    @Override
    default Phrase<V> visitMotorStopAction(MotorStopAction<Phrase<V>> motorStopAction) {
        return IBotnrollVisitor.super.visitMotorStopAction(motorStopAction);
    }
    ...
    default Phrase<V> visitPlayNoteAction(PlayNoteAction<Phrase<V>> playNoteAction) {
        return IBotnrollVisitor.super.visitPlayNoteAction(playNoteAction);
    }

    @Override
    default Phrase<V> visitPlayFileAction(PlayFileAction<Phrase<V>> playFileAction) {
        return IBotnrollVisitor.super.visitPlayFileAction(playFileAction);
    }

    @Override
    default Phrase<V> visitVolumeAction(VolumeAction<Phrase<V>> volumeAction) {
        return IBotnrollVisitor.super.visitVolumeAction(volumeAction);
    }
