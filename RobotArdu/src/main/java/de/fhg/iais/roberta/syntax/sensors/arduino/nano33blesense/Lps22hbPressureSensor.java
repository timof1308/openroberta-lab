...
public class Lps22hbPressureSensor<V> extends BuiltinSensor<V> {
    ...
    public static <V> Phrase<V> jaxbToAst(Block block, AbstractJaxb2Ast<V> helper) {
        ...
        Var<V> pressure = helper.getVar(values, "");
        return Lps22hbPressureSensor.make(AbstractJaxb2Ast.extractBlockProperties(block), AbstractJaxb2Ast.extractComment(block), pressure);
    }
    ...
    public Block astToBlock() {
        ...
        Ast2JaxbHelper.addValue(block, "", this.pressure);
        return block;
    }
}