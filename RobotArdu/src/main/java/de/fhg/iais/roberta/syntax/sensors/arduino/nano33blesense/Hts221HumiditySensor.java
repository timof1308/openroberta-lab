...
public class Hts221HumiditySensor<V> extends BuiltinSensor<V> {
    ...
    public static <V> Phrase<V> jaxbToAst(Block block, AbstractJaxb2Ast<V> helper) {
        ...
        Var<V> humidity = helper.getVar(values, "");
        return Hts221HumiditySensor.make(AbstractJaxb2Ast.extractBlockProperties(block), AbstractJaxb2Ast.extractComment(block), humidity);
    }
    ...
    public Block astToBlock() {
        ...
        Ast2JaxbHelper.addValue(block, "", this.humidity);
        return block;
    }
}