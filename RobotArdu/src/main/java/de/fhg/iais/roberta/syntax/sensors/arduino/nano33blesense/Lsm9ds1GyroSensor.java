...
public class Lsm9ds1GyroSensor<V> extends BuiltinSensor<V> {
    ...
    private Lsm9ds1GyroSensor(BlocklyBlockProperties properties, BlocklyComment comment, Var<V> x, Var<V> y, Var<V> z) {
        super(null, BlockTypeContainer.getByName("LSM9DS1_GYRO"), properties, comment);
        this.x = x;
        this.y = y;
        this.z = z;
        setReadOnly();
    ...
    public static <V> Phrase<V> jaxbToAst(Block block, AbstractJaxb2Ast<V> helper) {
        ...
        return Lsm9ds1GyroSensor.make(AbstractJaxb2Ast.extractBlockProperties(block), AbstractJaxb2Ast.extractComment(block), x, y, z);
    }
