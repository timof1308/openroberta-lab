...
public class Apds9960GestureSensor<V> extends BuiltinSensor<V> {
    ...
    public static <V> Phrase<V> jaxbToAst(Block block, AbstractJaxb2Ast<V> helper) {
        ...
        Var<V> gesture = helper.getVar(values, "");
        return Apds9960GestureSensor.make(AbstractJaxb2Ast.extractBlockProperties(block), AbstractJaxb2Ast.extractComment(block), gesture);
    }
    ...
    public Block astToBlock() {
        ...
        Ast2JaxbHelper.addValue(block, "", this.gesture);
        return block;
    }
}