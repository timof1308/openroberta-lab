...
public class Apds9960DistanceSensor<V> extends BuiltinSensor<V> {
    ...
    public static <V> Phrase<V> jaxbToAst(Block block, AbstractJaxb2Ast<V> helper) {
        ...
        Var<V> distance = helper.getVar(values, "");
        return Apds9960DistanceSensor.make(AbstractJaxb2Ast.extractBlockProperties(block), AbstractJaxb2Ast.extractComment(block), distance);
    }
    ...
    public Block astToBlock() {
        ...
        Ast2JaxbHelper.addValue(block, "", this.distance);
        return block;
    }
}